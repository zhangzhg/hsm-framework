...
/**
 * token策略，C端登陆?token=xxxx可访问B端
 *
 */
public class TokenHttpSessionStrategy implements HttpSessionStrategy {
	...
	class MultiSessionHttpServletResponse extends HttpServletResponseWrapper {
		...
		public String encodeRedirectURL(String url) {
			...
			return TokenHttpSessionStrategy.this.encodeURL(url, getCurrentSessionAlias(request));
		}
		...
		public String encodeURL(String url) {
			...
			return TokenHttpSessionStrategy.this.encodeURL(url, alias);
		}
	}
