...
public class Inflector {
    ...
    public String camelCase( String lowerCaseAndUnderscoredWord,
        ...
        if (lowerCaseAndUnderscoredWord.endsWith("_")){
    		lowerCaseAndUnderscoredWord = lowerCaseAndUnderscoredWord.substring(0,lowerCaseAndUnderscoredWord.length()-1);
    	}
    ...
    public void addIrregular( String singular,
        ...
        if(StringUtils.isEmpty(singular)){
            throw new IllegalArgumentException("singular is null.");
        }
        if(StringUtils.isEmpty(plural)){
            throw new IllegalArgumentException("plural is null.");
        }
